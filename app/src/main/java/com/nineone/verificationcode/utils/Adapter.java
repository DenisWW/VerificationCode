...
//
//package com.bitauto.carmodel.common.base.adapter.multitype;
//
...
//
//import static com.bitauto.carmodel.common.base.adapter.multitype.Preconditions.checkNotNull;
//
...
//     * distributed under the License is distributed carmodel_switch_tablayout_on an "AS IS" BASIS,
...
//         * </p >
//         *
//         * @param holder   The CarModelViewHolder which should be updated to represent the contents of the
...
//         * associated binder.
//         *
//         * @param holder The CarModelViewHolder for the view being recycled
...
//
//        /**
//         * Called by the RecyclerView if a CarModelViewHolder created by this Adapter cannot be recycled
//         * due to its transient state, and passes the event to its associated item view binder.
//         *
//         * @param holder The CarModelViewHolder containing the View that could not be recycled due to its
//         *               transient state.
...
//
//        /**
//         * A safe register method com.bitauto.carmodel.common.base carmodel_switch_tablayout_on the TypePool's safety for TypePool.
//         */
//        @SuppressWarnings("unchecked")
