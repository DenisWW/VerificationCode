...
class SimpleSelectHelper {
    public static CustomVerticallyLayoutManager createVerticallyLayoutManager
            (Context context, float normalTextSize, float maxTextSize) {
    ...
    public static SelectTextViewAdapter createVerticallyAdapter(
            float normalTextSize, float maxTextSize, int topAndBottomPadding, int itemCount, int gravity) {
        return new SelectTextViewAdapter(normalTextSize, maxTextSize, topAndBottomPadding, itemCount, gravity);
    }

    public static SelectSimpleTextViewAdapter createVerticallySimpleAdapter(
            float normalTextSize, float maxTextSize, int topAndBottomPadding, int itemCount, int gravity) {
    ...
    static class CustomVerticallyLayoutManager extends LinearLayoutManager {
        ...
        private SimplePlaceHolderSelectListLayout.SimpleSelectListener listener;
        ...
        public void setListener(SimplePlaceHolderSelectListLayout.SimpleSelectListener listener) {
        ...
        private int getCenterDistance(View child) {
            return (child.getHeight() - child.getPaddingTop() - child.getPaddingBottom()) / 2
                    + child.getTop() + child.getPaddingTop();
        }

    }

    private static void upItemTextView(
            ViewGroup child, int distanceCenter, float normalTextSize, float maxTextSize) {
        ...
        if (maxTextSize != normalTextSize) {
            float textSize = maxTextSize * tv.getResources().getDisplayMetrics().density
                    - (maxTextSize - normalTextSize) * tv.getResources().getDisplayMetrics().density * scaleValue;
    ...
    static class SelectTextViewAdapter extends RecyclerView.Adapter<SelectTextViewViewHolder> {
        ...
        public SelectTextViewAdapter(float normalTextSize, float maxTextSize,
                                     int topAndBottomPadding, int itemCount, int gravity) {
            this.normalTextSize = normalTextSize;
            this.maxTextSize = maxTextSize;
    ...
    static class SelectSimpleTextViewAdapter extends RecyclerView.Adapter<SelectTextViewViewHolder> {
        ...
        public SelectSimpleTextViewAdapter(float normalTextSize, float maxTextSize,
                                           int topAndBottomPadding, int itemHeight, int gravity) {
            this.normalTextSize = normalTextSize;
            this.maxTextSize = maxTextSize;
            this.gravity = gravity;
    ...
    static class SelectTextViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public SelectTextViewViewHolder(
                @NonNull View itemView, float normalTextSize, float maxTextSize,
                int topAndBottomPadding, int gravity) {
            super(itemView);
            ...
            invisibleTv.setPadding(0, (int) linearLayout.getResources().getDisplayMetrics().density * topAndBottomPadding,
                    0, (int) itemView.getResources().getDisplayMetrics().density * topAndBottomPadding);
